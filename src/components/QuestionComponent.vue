...
<h3 style="margin:3vh">{{answer.label}}</h3>
...
class="custom-btn"
 ...
 v-for="answerObject in question.answers" v-on:click="answer(answerObject)" v-bind:key="answerObject" style="margin:1vh; font-size: 1vh">
  {{answerObject.label}}                  
</button>
<div class="CountDown">
